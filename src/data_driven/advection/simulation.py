...
branch_hidden6_bias = np.loadtxt(r'/classical_training/branch.hidden_layers.6.bias.txt')
branch_hidden6_thetas = np.loadtxt(r'/classical_training/branch.hidden_layers.6.thetas.txt')
...
trunk_hidden6_bias = np.loadtxt(r'/classical_training/trunk.hidden_layers.6.bias.txt')
trunk_hidden6_thetas = np.loadtxt(r'/classical_training/trunk.hidden_layers.6.thetas.txt')
...
for x_branch0 in x_test[0]:
    x_branch = x_branch0
    x_branch = silu(tomo_output(10+1,21, x_branch, branch_hidden0_thetas,simulator)+branch_hidden0_bias)
    ...
    x_branch = silu(tomo_output(21,21, x_branch, branch_hidden5_thetas,simulator)+branch_hidden5_bias) + \
        x_branch/np.linalg.norm(x_branch)

    x_branch = silu(tomo_output(21,21, x_branch, branch_hidden6_thetas,simulator)+branch_hidden6_bias) + \
        x_branch/np.linalg.norm(x_branch)
...
for x_trunk in x_test[1]:
    x_trunk = silu(tomo_output(1+1,21, x_trunk, trunk_hidden0_thetas,simulator)+trunk_hidden0_bias)
    ...
    x_trunk = silu(tomo_output(21,21, x_trunk, trunk_hidden5_thetas,simulator)+trunk_hidden5_bias) + \
        x_trunk/np.linalg.norm(x_trunk)
        
    x_trunk = silu(tomo_output(21,21, x_trunk, trunk_hidden6_thetas,simulator)+trunk_hidden6_bias) + \
        x_trunk/np.linalg.norm(x_trunk)
